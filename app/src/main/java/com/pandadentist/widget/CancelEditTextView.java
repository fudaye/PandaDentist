...
/**
 * Created by Ford on 2016/8/24.
 * <p>
 * 带关闭的EditText
 */
public class CancelEditTextView extends EditText implements TextWatcher, View.OnFocusChangeListener {
    ...
    public CancelEditTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public CancelEditTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private onEditTextChangeListener l;

    public void setTextChangeListener(onEditTextChangeListener l) {
        this.l = l;
