...
public class IndicatorView extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.ooch_indicator_selector;
    ...
    public IndicatorView(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorColor = context.getResources().getColor(android.R.color.transparent);
        tabTextFocus = context.getResources().getColor(R.color.colorPrimary);
        tabTextColorNormal = context.getResources().getColor(android.R.color.black);

        tabsContainer = new LinearLayout(context);
        tabsContainer.setOrientation(LinearLayout.HORIZONTAL);
        tabsContainer.setLayoutParams(new LayoutParams((int) context.getResources().getDisplayMetrics().widthPixels, LayoutParams.MATCH_PARENT));
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                clearTabTextColor();
                textView.setTextColor(tabTextFocus);
                currentPosition = position;
                if (l != null) {
                    l.onTabClick(v, position);
                }
            }
        });
    ...
    public void setTextFocusColor(int textColor) {
        this.tabTextFocus = textColor;
        updateTabStyles();
    }
